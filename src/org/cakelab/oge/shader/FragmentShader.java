...
public class FragmentShader extends Shader {
	...
	public FragmentShader(String glslSource) throws GLCompilerException {
		super(TYPE, "fragment", glslSource);
	}
	...
	public FragmentShader(File glslSource)
			throws GLCompilerException, IOException {
		super(TYPE, glslSource);
	}

	public FragmentShader(String name, File glslSource)
			throws GLCompilerException, IOException {
		super(TYPE, name, glslSource);
	}
